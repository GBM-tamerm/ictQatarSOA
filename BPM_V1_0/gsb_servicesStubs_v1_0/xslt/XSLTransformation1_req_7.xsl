...
<!-- @generated mapFile="xslt/XSLTransformation1_req_7.map" md5sum="a9288823e19927848e2b394e8a770e6e" version="6.2.200" -->
<!--
*****************************************************************************
...
*   Input file(s):		smo://smo/name%3Dwsdl-primary/message%3D%257Burn%253Amol.gov.qa%252FcustomerService%252Frecruitment%252Fspecifications%252Fv1_0%252F%257DLookupsgetProfessionsListRequest/xpath%3D%252Fbody/smo.xsd
*   Output file(s):		smo://smo/name%3Dwsdl-primary/message%3D%257Burn%253Amol.gov.qa%252FcustomerService%252Frecruitment%252Fspecifications%252Fv1_0%252F%257DLookupsgetProfessionsListResponse/xpath%3D%252Fbody/smo.xsd
*
...
<xsl:stylesheet
  ...
  <!-- root template  -->
  <xsl:template match="/">
    <xsl:apply-templates select="body" mode="XSLTransformation1_req_7"/>
  </xsl:template>

  <!-- This rule represents an element mapping: "body" to "body".  -->
  <xsl:template match="body"  mode="XSLTransformation1_req_7">
    <body>
      <io2:LookupsgetProfessionsListResponse1>
        <io2:professionsList>
