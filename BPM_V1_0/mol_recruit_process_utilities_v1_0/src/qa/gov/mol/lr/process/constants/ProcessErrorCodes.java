...
public interface ProcessErrorCodes {
	...
	//  This error code raised if failed to get bill information in Perform screening process
	public static final String billInfoFailure ="9615";
	//  This error code raised if failed to get est statistics service in Perform screening process
	public static final String estStatisticsFailure ="9614";
	// this is the network location default value in commonErrorStrucure for excpetions in process
	public static final String networkLocation ="Process-MOL-%";
