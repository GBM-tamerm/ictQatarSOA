...
public class ProfessionType_Ser extends com.ibm.ws.webservices.engine.encoding.ser.BeanSerializer {
    /**
     * Constructor
     */
    public ProfessionType_Ser(
        ...
        throws java.io.IOException
    {
           ...
           elemQName = QName_6_26;
           context.qName2String(elemQName, true);
           elemQName = QName_6_27;
           context.qName2String(elemQName, true);
    ...
    protected void addElements(
        ...
        throws java.io.IOException
    {
        ProfessionType bean = (ProfessionType) value;
        java.lang.Object propValue;
        javax.xml.namespace.QName propQName;
        {
          propQName = QName_6_26;
          propValue = bean.getName_En();
          ...
          propQName = QName_6_27;
          propValue = bean.getName_Ar();
          if (propValue != null && !context.shouldSendXSIType()) {
            context.simpleElement(propQName, null, propValue.toString()); 
          } else {
            serializeChild(propQName, null, 
