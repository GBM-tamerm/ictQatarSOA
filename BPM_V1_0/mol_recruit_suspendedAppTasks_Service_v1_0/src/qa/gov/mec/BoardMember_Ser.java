...
public class BoardMember_Ser extends com.ibm.ws.webservices.engine.encoding.ser.BeanSerializer {
    /**
     * Constructor
     */
    public BoardMember_Ser(
    ...
    protected void addElements(
        ...
        throws java.io.IOException
    {
        BoardMember bean = (BoardMember) value;
        ...
        javax.xml.namespace.QName propQName;
        {
          ...
          propQName = QName_4_205;
          propValue = bean.getDesignation();
          if (propValue != null && !context.shouldSendXSIType()) {
            context.simpleElement(propQName, null, propValue.toString()); 
          } else {
            serializeChild(propQName, null, 
