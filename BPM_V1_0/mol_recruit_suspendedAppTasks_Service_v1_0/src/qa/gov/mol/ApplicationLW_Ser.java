...
public class ApplicationLW_Ser extends com.ibm.ws.webservices.engine.encoding.ser.BeanSerializer {
    /**
     * Constructor
     */
    public ApplicationLW_Ser(
    ...
    protected void addElements(
        ...
        throws java.io.IOException
    {
        ApplicationLW bean = (ApplicationLW) value;
        ...
        javax.xml.namespace.QName propQName;
        {
          ...
          propValue = bean.getProcessMetadata();
          serializeChild(propQName, null, 
              propValue, 
              QName_0_110,
              true,null,context);
