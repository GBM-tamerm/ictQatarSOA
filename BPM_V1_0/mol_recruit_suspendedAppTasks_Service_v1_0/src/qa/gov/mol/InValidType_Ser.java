...
public class InValidType_Ser extends com.ibm.ws.webservices.engine.encoding.ser.BeanSerializer {
    /**
     * Constructor
     */
    public InValidType_Ser(
    ...
    protected void addElements(
        ...
        throws java.io.IOException
    {
        InValidType bean = (InValidType) value;
        ...
        javax.xml.namespace.QName propQName;
        {
          ...
          propValue = bean.getService();
          serializeChild(propQName, null, 
              propValue, 
              QName_0_121,
              true,null,context);
          propQName = QName_0_119;
          propValue = bean.getMolRejectionReason();
