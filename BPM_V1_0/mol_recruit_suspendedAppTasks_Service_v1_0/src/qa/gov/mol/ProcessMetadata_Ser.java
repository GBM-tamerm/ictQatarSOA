...
public class ProcessMetadata_Ser extends com.ibm.ws.webservices.engine.encoding.ser.BeanSerializer {
    /**
     * Constructor
     */
    public ProcessMetadata_Ser(
    ...
    protected void addElements(
        ...
        throws java.io.IOException
    {
        ProcessMetadata bean = (ProcessMetadata) value;
        java.lang.Object propValue;
        javax.xml.namespace.QName propQName;
        {
          propQName = QName_0_111;
          propValue = bean.getStepID();
          ...
          propValue = bean.getFaultMessage();
          if (propValue != null && !context.shouldSendXSIType()) {
            context.simpleElement(propQName, null, propValue.toString()); 
          } else {
            serializeChild(propQName, null, 
          ...
          propValue = bean.getCorrelationID();
          if (propValue != null && !context.shouldSendXSIType()) {
            context.simpleElement(propQName, null, propValue.toString()); 
          } else {
            serializeChild(propQName, null, 
